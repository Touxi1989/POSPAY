...
public class StringUtil {
    public static void Log(String str){
        android.util.Log.w("tpemvservice" ,str);
    }
    ...
    public static void printHashMapContent(java.util.HashMap map) {
        java.util.List<java.util.Map.Entry<String,Object>> list = new java.util.ArrayList<java.util.Map.Entry<String,Object>>(map.entrySet());
        java.util.Collections.sort(list,new java.util.Comparator<java.util.Map.Entry<String,Object>>() {
            //升序排序
        ...
        for(java.util.Map.Entry<String,Object> entry : list){
...
//            }
    ...
    public static int sAmount2Int(String sAmount){
        ...
        java.math.BigDecimal a = new java.math.BigDecimal(sAmount);
    ...
    public static String formatAmountTo12bit(long amount) {
        String temp = "" + amount;
        for (; temp.length() < 12; ) {
            temp = "0" + temp;
        }
    ...
    public static String formatAmountTo3bit(long amount) {
        String temp = "" + amount;
        for (; temp.length() < 3; ) {
            temp = "0" + temp;
        }
    ...
    // 写数据到文件
    public static void writeFile(String fileName, byte[] write_str) throws java.io.IOException {
        try {
